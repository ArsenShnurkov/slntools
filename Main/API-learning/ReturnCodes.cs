// http://stackoverflow.com/questions/261663
...
public sealed class ReturnCodes : RichEnum<int, ReturnCodes>
{
	[Description("SUCCESS")] 
	public static readonly ReturnCodes SUCCESS = new ReturnCodes(0);
	[Description("NO_ENOUGH_ARGUMENTS")] 
	public static readonly ReturnCodes NO_ENOUGH_ARGUMENTS = new ReturnCodes(1);
	[Description("EXCEPTION")] 
	public static readonly ReturnCodes EXCEPTION = new ReturnCodes(2);

	private ReturnCodes(int value) : base (value)
	{
	}

	public static implicit operator ReturnCodes(byte value)
	{
